...
// Switch
#define	SW_UP_DATA				(GpioDataRegs.GPADAT.bit.GPIO31^ON)
#define	SW_DOWN_DATA			(GpioDataRegs.GPADAT.bit.GPIO30^ON)
#define SW_RIGHT_DATA			(GpioDataRegs.GPADAT.bit.GPIO15^ON)
#define SW_LEFT_DATA			(GpioDataRegs.GPADAT.bit.GPIO14^ON)
